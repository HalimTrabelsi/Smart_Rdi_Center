...
public:
    ...
    QLineEdit *le_IDS;
    QLabel *label_10;
    QPushButton *triBudgetCroissant;
    QLineEdit *recherche;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox->setGeometry(QRect(-150, 0, 1231, 711));
        groupBox->setAutoFillBackground(false);
        groupBox->setStyleSheet(QLatin1String("background-color: #be7fbe;\n"
"font: 12pt \"Cambria\";\n"
...
"}"));
        ...
        tabWidget->setGeometry(QRect(150, 10, 1071, 691));
...
"border-right: 3px solid #ffc778 ;\n"
"border-top: 3px solid #ffc778 ;\n"
"border-left:  3px solid #ffc778 ;\n"
"border-bottom: 3px solid #ffc778 ;\n"
"\n"
"}\n"
"\n"
"QTabBar::tab:selected, QTabBar::tab:hover {\n"
"background:rgb#ffc778 ;\n"
"color:rgb(255, 255, 255);\n"
"}\n"
""));
        general = new QWidget();
        ...
        groupBox_2->setStyleSheet(QLatin1String("background-color: #be7fbe;\n"
"font: 12pt \"Cambria\";\n"
"QTabWidget::pane { /* The tab widget frame */\n"
"border-right: 3px solid rgb(255, 0, 0);\n"
"border-top: 3px solid rgb(255, 0, 0);\n"
...
"}"));
        ...
        label_4->setGeometry(QRect(10, 110, 81, 20));
        ...
        pushButton_ajouter->setStyleSheet(QLatin1String("background-color: #ffc778 ;\n"
"font: 14pt \"Cambria\";"));
        ...
        pb_modifier->setStyleSheet(QLatin1String("background-color: #ffc778 ;\n"
"font: 14pt \"Cambria\";"));
        le_find = new QLineEdit(groupBox_2);
        le_find->setObjectName(QStringLiteral("le_find"));
        le_find->setGeometry(QRect(92, 400, 201, 31));
        ...
        groupBox_6->setGeometry(QRect(340, 110, 701, 301));
        groupBox_6->setStyleSheet(QLatin1String("background-color: #be7fbe;\n"
"font: 12pt \"Cambria\";\n"
"QTabWidget::pane { /* The tab widget frame */\n"
"border-right: 3px solid rgb(255, 0, 0);\n"
"border-top: 3px solid rgb(255, 0, 0);\n"
...
"}"));
        ...
        tab_etudiant->setGeometry(QRect(20, 30, 641, 241));
        tab_etudiant->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        groupBox_7 = new QGroupBox(general);
        groupBox_7->setObjectName(QStringLiteral("groupBox_7"));
        groupBox_7->setGeometry(QRect(350, 420, 431, 201));
        groupBox_7->setStyleSheet(QLatin1String("background-color: #be7fbe;\n"
"font: 12pt \"Cambria\";\n"
"QTabWidget::pane { /* The tab widget frame */\n"
"border-right: 3px solid rgb(255, 0, 0);\n"
"border-top: 3px solid rgb(255, 0, 0);\n"
...
"}"));
        ...
        pushButton_supprimer->setStyleSheet(QLatin1String("background-color: #ffc778 ;\n"
"font: 14pt \"Cambria\";"));
        le_IDS = new QLineEdit(groupBox_7);
        le_IDS->setObjectName(QStringLiteral("le_IDS"));
        le_IDS->setGeometry(QRect(90, 70, 211, 22));
        ...
        triBudgetCroissant = new QPushButton(general);
        triBudgetCroissant->setObjectName(QStringLiteral("triBudgetCroissant"));
        triBudgetCroissant->setGeometry(QRect(820, 80, 191, 28));
        recherche = new QLineEdit(general);
        recherche->setObjectName(QStringLiteral("recherche"));
        recherche->setGeometry(QRect(440, 20, 461, 51));
        recherche->setStyleSheet(QLatin1String("QLineEdit {\n"
...
"\n"
""));
        recherche->setReadOnly(false);
        recherche->setClearButtonEnabled(true);
        ButtonPDF = new QPushButton(general);
        ButtonPDF->setObjectName(QStringLiteral("ButtonPDF"));
        ButtonPDF->setGeometry(QRect(860, 430, 171, 28));
        ...
        toolBar->setStyleSheet(QLatin1String("background-color: #be7fbe;\n"
"font: 12pt \"Cambria\";\n"
"QTabWidget::pane { /* The tab widget frame */\n"
"border-right: 3px solid rgb(255, 0, 0);\n"
"border-top: 3px solid rgb(255, 0, 0);\n"
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_2->setTitle(QApplication::translate("MainWindow", "Ajouter projet", Q_NULLPTR));
        ...
        le_find->setText(QApplication::translate("MainWindow", "Mettez ici l'ID pour modifier", Q_NULLPTR));
        le_find->setPlaceholderText(QString());
        label_12->setText(QApplication::translate("MainWindow", "ID ", Q_NULLPTR));
        groupBox_6->setTitle(QApplication::translate("MainWindow", "Afficher projets", Q_NULLPTR));
        groupBox_7->setTitle(QApplication::translate("MainWindow", "Supprimer projet", Q_NULLPTR));
        pushButton_supprimer->setText(QApplication::translate("MainWindow", "Supprimer", Q_NULLPTR));
        le_IDS->setText(QApplication::translate("MainWindow", "Mettez ici l'ID pour supprimer", Q_NULLPTR));
        label_10->setText(QApplication::translate("MainWindow", "ID", Q_NULLPTR));
        triBudgetCroissant->setText(QApplication::translate("MainWindow", "Trier", Q_NULLPTR));
        recherche->setInputMask(QString());
        recherche->setText(QString());
        recherche->setPlaceholderText(QApplication::translate("MainWindow", "                                   Chercher Projet", Q_NULLPTR));
        ButtonPDF->setText(QApplication::translate("MainWindow", "Cr\303\251\303\251 un PDF", Q_NULLPTR));
